...
describe Spree::PaymentMethod::BraintreeCreditCard do
  subject do
    Spree::PaymentMethod::BraintreeCreditCard.create!(name: 'Braintree ', active: true)
  end
  ...
  def with_payment_profiles_off(&block)
    Spree::PaymentMethod::BraintreeCreditCard.class_eval do
