...
describe Spree::PaymentMethod::AuthorizeNet do
  subject { described_class.create!(name: 'Authorize.net') }

  context '.gateway_class' do
    it 'is a AuthorizeNet gateway' do
      expect(subject.gateway_class).to eq ::ActiveMerchant::Billing::AuthorizeNetGateway
    end
  end
